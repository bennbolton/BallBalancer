 ...
 ***************************************************************/
 ...
 void setup()
 {
   ...
   while (!initialized)
   {
     ...
     myICM2.begin(WIRE_PORT, 0);
 #endif
 
     SERIAL_PORT.print(F("Initialization of the sensor1 returned: "));
   ...
   SERIAL_PORT.print(F("Initialization of the sensor2 returned: "));
   SERIAL_PORT.println(myICM2.statusString());
 
   SERIAL_PORT.println(F("Devices connected!"));
   ...
   success &= (myICM2.enableDMPSensor(INV_ICM20948_SENSOR_RAW_ACCELEROMETER) == ICM_20948_Stat_Ok);
   ...
   success &= (myICM2.setDMPODRrate(DMP_ODR_Reg_Quat6, 0) == ICM_20948_Stat_Ok); // Set to 225Hz
   success &= (myICM2.setDMPODRrate(DMP_ODR_Reg_Accel, 0) == ICM_20948_Stat_Ok); // Set to 225Hz
