...
void loop() {
  ...
  RobotDirection dir = vectorFromAngle(tiltHeading, PID2(tiltAngle));
...
void getTilt(double qIn[4]) {
  ...
  tiltAngle = acosf(up_z) * RAD_TO_DEG;
  tiltHeading = atan2f(up_y, up_x) * RAD_TO_DEG;
}
